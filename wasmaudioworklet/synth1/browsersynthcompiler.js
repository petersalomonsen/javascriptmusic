...
const ready = new Promise(resolve => fetch(new URL('wasmsynthassemblyscriptsources.json', import.meta.url)).then(r => r.json())
    .then(obj => {
...
async function compile(params) {
    const synthsource = params.synthsource;
    ...
    try {
        if (params.song) {
            ...
            console.log(params.song, params.exportmode);
            createWebAssemblySongData(params.song, params.exportmode);
