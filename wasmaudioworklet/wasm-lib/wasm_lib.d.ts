 ...
 */
export function create_signed_transaction(signer_id: string, public_key_b58: string, private_key_b58: string, receiver_id: string, method_name: string, args_json: string, nonce: bigint, block_hash_b58: string, gas: bigint, deposit: string): string;
